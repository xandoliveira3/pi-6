...
export default function UsuariosScreen({ zoomLevel = 1 }: UsuariosScreenProps) {
  ...
  const ativos = usuarios.filter(u => u.ativo && u.tipo_usuario === 'usuario');
    ...
    >
            ...
            <View key={usuario.id} style={[styles.card, styles.cardAtivo]}>
              ...
              <View style={styles.cardStatus}>
                <View style={styles.statusBadgeAtivo}>
                  <Text style={[styles.statusBadgeText, { fontSize: scale(11) }]}>Ativo</Text>
                </View>
              </View>
            </View>
          ))}
            ...
            <View key={usuario.id} style={[styles.card, styles.cardAdmin]}>
              ...
              <View style={styles.cardStatus}>
                <View style={styles.statusBadgeAdmin}>
                  <Text style={[styles.statusBadgeText, { fontSize: scale(11) }]}>Admin</Text>
                </View>
              </View>
            </View>
          ))}
      ...
      {usuarios.length === 0 && (
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.emptyText, { fontSize: scale(14) }]}>Nenhum usuário cadastrado</Text>
        </View>
      )}
